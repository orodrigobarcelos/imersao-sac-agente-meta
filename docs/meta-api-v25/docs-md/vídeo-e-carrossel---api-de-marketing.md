<!-- Fonte: Vídeo e carrossel - API de Marketing.html -->
<!-- URL: https://developers.facebook.com/docs/marketing-api/guides/videoads -->
...
- Etapa 1: [fornecer criativos do anúncio](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad-creative)
- Etapa 2: [criar campanha de anúncios](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad-campaign)
- Etapa 3: [criar um conjunto de anúncios](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad-set)
- Etapa 4: [criar um anúncio](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad)
...
Consulte [Referência: campanha](https://developers.facebook.com/docs/marketing-api/reference/ad-campaign-group), [AdObjectives em PHP](https://l.facebook.com/l.php?u=https%3A%2F%2Fgithub.com%2Ffacebook%2Ffacebook-php-ads-sdk%2Fblob%2Fmaster%2Fsrc%2FFacebookAds%2FObject%2FValues%2FAdObjectives.php&h=AT4HxiWsXWoEzY55mGqrvHGlvNdD89L16qHbRl6E-VOByAkLQ8VpuXmp9SH3xWZMY1_OuQM3n-vjHjiwCS9xzsf6GOzrHRJPf0JrO8eVpCHhkRbTIvIv_QKzyPDRoo6dGYxV34v3wznP8eJRe4oqzuiDXFo) e [AdObjectives em Python](https://l.facebook.com/l.php?u=https%3A%2F%2Fgithub.com%2Ffacebook%2Ffacebook-python-ads-sdk%2Fblob%2F199daddec0174ac45d4ee985490b987739cb13af%2Ffacebookads%2Fmixins.py%23L128&h=AT4IGIokE7LCTxTjLnfjhum54-NAtB4ybWQgk7V3IUklmOTt1VcZkeswjYE2zVJfb434UjIHPWQhhjFat1_GnVm7WM6yj2xh-bAULlErBTepD-iljYZiX72HrnL-4Md-Y8GliU8OJKfD2JNpDMo0XYa4r3o)
...
As taxas de custo por visualização são menores para conjuntos de anúncios com `optimization_goal=THRUPLAY` se comparadas a CPVs de compras por alcance e frequência otimizadas para visualizações de vídeo. A data final deve estar no futuro. Consulte a [Referência: Ad Set](https://developers.facebook.com/docs/marketing-api/reference/ad-campaign).
...
Para disponibilizar um vídeo a mais pessoas, use o objetivo da campanha de visualização do vídeo com [alcance e frequência](https://developers.facebook.com/docs/reference/ads-api/reachandfrequency). Você precisará criar uma previsão, reservá-la e atribuí-la ao seu conjunto de anúncios.


Siga a [criação da visualização do vídeo](https://developers.facebook.com/docs/marketing-api/guides/videoads#video_create), mas aplique alcance e frequência ao seu conjunto de anúncios. Especifique estes parâmetros adicionais:
...
- **Alcance pessoas que assistiram a um vídeo**. Do reconhecimento a afinidade e consideração. Consulte [Remarketing](https://developers.facebook.com/docs/marketing-api/guides/videoads#remarketing).
- **Tenha engajamento com marcas e produtos**. Adicione uma chamada para ação para visitar uma página específica no seu site. Consulte [Chamada para ação](https://developers.facebook.com/docs/marketing-api/guides/videoads#call_to_action).
...
- `PAGE_LIKES`
- [`LEAD_GENERATION`](https://developers.facebook.com/docs/marketing-api/guides/lead-ads/create#video)
- [`LOCAL_AWARENESS`](https://developers.facebook.com/docs/marketing-api/guides/local-awareness)
- `LINK_CLICKS`
- `CONVERSIONS`
- [`APP_INSTALLS`](https://developers.facebook.com/docs/marketing-api/mobile-app-ads/#create_video)
- `VIDEO_VIEWS`
- `BRAND_AWARENESS`
...
**Estamos fazendo testes limitados com a opção `action_video_type` no momento.** Para identificar clientes com o detalhamento, verifique `CAN_USE_VIDEO_METRICS_BREAKDOWN` da [conta de anúncios](https://developers.facebook.com/docs/reference/ads-api/adaccount).
...
- Criar uma [post sem exibição na Página](https://developers.facebook.com/docs/reference/ads-api/unpublished-page-posts/) e um [criativo do anúncio](https://developers.facebook.com/docs/reference/ads-api/adcreative/) por meio do post (indisponível para carrossel de vídeo)
...
Crie um post sem exibição na Página. `child_attachments` é uma [matriz de objetos de link](https://developers.facebook.com/docs/marketing-api/guides/videoads#spec). Em cada objeto de link, `picture`, `name` e `description` são opcionais. Você pode publicá-los apenas pela Página com um token de acesso à Página.
...
| child_attachments.link tipo: string | URL do link ou URL da loja de apps anexado ao post. Obrigatório. |
...
| child_attachments.image_hash tipo: string | Hash de uma imagem de prévia associada ao link da sua biblioteca de imagens . Use a taxa de proporção 1:1 e um mínimo de 458 x 458 px para uma melhor exibição. É preciso especificar picture ou image_hash . |
| child_attachments.name tipo: string | Título da prévia do link. Se não especificado, o título da página vinculada será usado. Normalmente truncado depois de 35 caracteres. Defina um name único, já que as interfaces do Facebook mostram ações relatadas por name . |
...
| child_attachments.video_id tipo: string | ID do vídeo do anúncio . Pode ser usado em qualquer elemento secundário. Se especificado, será necessário definir image_hash ou picture . |
| message tipo: string | Corpo principal do post, também chamado de mensagem de status. |
| link tipo: string | URL de um link para “Ver mais”. Obrigatório. |
| caption tipo: string | URL para exibir no link “Ver mais”. Não aplicável para anúncios de app móvel em carrossel |
...
- [Anúncios em carrossel do Instagram](https://developers.facebook.com/docs/marketing-api/guides/instagramads/#carousel)
[○](https://developers.facebook.com/docs/marketing-api/guides/videoads#)[○](https://developers.facebook.com/docs/marketing-api/guides/videoads#)Nesta Página[Anúncios em vídeo e em carrossel](https://developers.facebook.com/docs/marketing-api/guides/videoads#an-ncios-em-v-deo-e-em-carrossel)[Anúncios em vídeo](https://developers.facebook.com/docs/marketing-api/guides/videoads#video_create)[Etapa 1: fornecer criativos do anúncio](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad-creative)[Etapa 2: criar campanha de anúncios](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad-campaign)[Etapa 3: criar um conjunto de anúncios](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad-set)[Etapa 4: criar um anúncio](https://developers.facebook.com/docs/marketing-api/guides/videoads#create-ad)[Vídeo para resposta direta](https://developers.facebook.com/docs/marketing-api/guides/videoads#dr)[Remarketing](https://developers.facebook.com/docs/marketing-api/guides/videoads#remarketing)[Chamada para ação](https://developers.facebook.com/docs/marketing-api/guides/videoads#call_to_action)[Métricas de vídeo](https://developers.facebook.com/docs/marketing-api/guides/videoads#metrics)[Insights de post de vídeo, Orgânico](https://developers.facebook.com/docs/marketing-api/guides/videoads#pageinsights)[Insights do anúncio em vídeo, Pago](https://developers.facebook.com/docs/marketing-api/guides/videoads#adstats)[Tipo de vídeo](https://developers.facebook.com/docs/marketing-api/guides/videoads#type)[Anúncios em carrossel](https://developers.facebook.com/docs/marketing-api/guides/videoads#carousel)[Criar em linha](https://developers.facebook.com/docs/marketing-api/guides/videoads#inline)[Criar o post e depois o anúncio](https://developers.facebook.com/docs/marketing-api/guides/videoads#pageFirst)[Criar anúncio em carrossel com vídeos](https://developers.facebook.com/docs/marketing-api/guides/videoads#create_video)[Criar anúncio de app para celular](https://developers.facebook.com/docs/marketing-api/guides/videoads#create_mobile)[Especificação de campo](https://developers.facebook.com/docs/marketing-api/guides/videoads#spec)[Estatísticas do anúncio por produto](https://developers.facebook.com/docs/marketing-api/guides/videoads#stats)[Posicionamentos](https://developers.facebook.com/docs/marketing-api/guides/videoads#place)[Veja também](https://developers.facebook.com/docs/marketing-api/guides/videoads#veja-tamb-m) react-mount-point-unstable Build with Meta[AI](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.llama.com%2F%3Ffbclid%3DIwZXh0bgNhZW0CMTAAYnJpZBExczI3SHZlNGdvMmlHblBZYnNydGMGYXBwX2lkATAAAR7E6QL_OTxfgsSEEadU3ZltHfucedhsSG-phFo2RLKOZWYCYzZ1ewFHIk6t1Q_aem_WCFHnWWBKxsuiB1hIoAjuw&h=AT6dH4luV-IpA1V_UjmouccpGUrsfhhO3AkhRJzq7NRvZHjd7Z50plPsIjTO3EUyvoXtMk2-r9ojO7ErpvSKC-vR33WmbbSMplYWcXkgBWQO2gSdtsrkz6XuIyRYZkOObrVNyeVjLd9ldVp7PDQGqRrrX4o)[Meta Horizon](https://l.facebook.com/l.php?u=https%3A%2F%2Fdevelopers.meta.com%2Fhorizon%2F%3Ffbclid%3DIwZXh0bgNhZW0CMTAAYnJpZBExczI3SHZlNGdvMmlHblBZYnNydGMGYXBwX2lkATAAAR7_O_bghgJf6py2Ql_9hT1BLZAGBJRwX0JOiNdqFImvxOMtzFZRqYL3Yuej6w_aem_5prVz0r4oslQn3m42kJFiQ&h=AT6dH4luV-IpA1V_UjmouccpGUrsfhhO3AkhRJzq7NRvZHjd7Z50plPsIjTO3EUyvoXtMk2-r9ojO7ErpvSKC-vR33WmbbSMplYWcXkgBWQO2gSdtsrkz6XuIyRYZkOObrVNyeVjLd9ldVp7PDQGqRrrX4o)[Social technologies](https://developers.facebook.com/social-technologies/)[Wearables](https://l.facebook.com/l.php?u=https%3A%2F%2Fdevelopers.meta.com%2Fwearables%2F%3Ffbclid%3DIwZXh0bgNhZW0CMTAAYnJpZBExczI3SHZlNGdvMmlHblBZYnNydGMGYXBwX2lkATAAAR6mt7drM_VXVpMYMlFVVeKrSE2bI7J5tFqoYGLHiMTEU18CuDKnDfK9c0sEPQ_aem_f3miNVaEtvQ5t26TAXU5tQ&h=AT6dH4luV-IpA1V_UjmouccpGUrsfhhO3AkhRJzq7NRvZHjd7Z50plPsIjTO3EUyvoXtMk2-r9ojO7ErpvSKC-vR33WmbbSMplYWcXkgBWQO2gSdtsrkz6XuIyRYZkOObrVNyeVjLd9ldVp7PDQGqRrrX4o)News[Meta for Developers](https://l.facebook.com/l.php?u=https%3A%2F%2Fdevelopers.meta.com%2Fblog%2F%3Ffbclid%3DIwZXh0bgNhZW0CMTAAYnJpZBExczI3SHZlNGdvMmlHblBZYnNydGMGYXBwX2lkATAAAR43m1LZYIe9K5B9HrewQSPxR0Bqtl6PGGWujnBuP9aRSptMIHlrLrYaWG_S-w_aem_kxld0Z0jpuwJxa7fmvO5jw&h=AT6dH4luV-IpA1V_UjmouccpGUrsfhhO3AkhRJzq7NRvZHjd7Z50plPsIjTO3EUyvoXtMk2-r9ojO7ErpvSKC-vR33WmbbSMplYWcXkgBWQO2gSdtsrkz6XuIyRYZkOObrVNyeVjLd9ldVp7PDQGqRrrX4o)[Blog](https://developers.facebook.com/blog/)[Success stories](https://developers.facebook.com/success-stories/)Support[Developer Support](https://developers.facebook.com/support/)[Bug tool](https://developers.facebook.com/support/bugs/)[Platform status](https://l.facebook.com/l.php?u=https%3A%2F%2Fmetastatus.com%2F%3Ffbclid%3DIwZXh0bgNhZW0CMTAAYnJpZBExczI3SHZlNGdvMmlHblBZYnNydGMGYXBwX2lkATAAAR6NMgiDPC0ZOyDdP-5GYOAp3LPN2Snxki8ptrtXL4MQWHfOyKSFkhjfB2eYLw_aem_I3lYuB62qxHQA8jL5TJvjA&h=AT6dH4luV-IpA1V_UjmouccpGUrsfhhO3AkhRJzq7NRvZHjd7Z50plPsIjTO3EUyvoXtMk2-r9ojO7ErpvSKC-vR33WmbbSMplYWcXkgBWQO2gSdtsrkz6XuIyRYZkOObrVNyeVjLd9ldVp7PDQGqRrrX4o)[Developer community forum](https://www.facebook.com/groups/fbdevelopers/)[Report an incident](https://developers.facebook.com/incident/report/)Terms and policies[Responsible platform initiatives](https://developers.facebook.com/products/responsible-platform-initiatives/)[Platform terms](https://developers.facebook.com/terms/dfc_platform_terms/)[Developer policies](https://developers.facebook.com/devpolicy/)[Privacy policy](https://www.facebook.com/about/privacy)[Cookies](https://www.facebook.com/help/cookies)About us[About](https://l.facebook.com/l.php?u=https%3A%2F%2Fabout.fb.com%2F&h=AT6dH4luV-IpA1V_UjmouccpGUrsfhhO3AkhRJzq7NRvZHjd7Z50plPsIjTO3EUyvoXtMk2-r9ojO7ErpvSKC-vR33WmbbSMplYWcXkgBWQO2gSdtsrkz6XuIyRYZkOObrVNyeVjLd9ldVp7PDQGqRrrX4o)[Careers](https://www.facebook.com/careers)Build with Meta[AI](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww