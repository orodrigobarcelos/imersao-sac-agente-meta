<!-- Fonte: Ad Campaign Group Ads _ Developer Documentation.html -->
<!-- URL: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-campaign-group/ads -->
...
```
GET /v25.0/<AD_CAMPAIGN_ID>/ads?fields=name HTTP/1.1Host: graph.facebook.com
```
...
| updated_since integer | SELF_EXPLANATORY |
