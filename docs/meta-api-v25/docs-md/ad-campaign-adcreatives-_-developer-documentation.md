<!-- Fonte: Ad Campaign Adcreatives _ Developer Documentation.html -->
<!-- URL: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-campaign/adcreatives -->
...
```
GET /v25.0/{ad-set-id}/adcreatives HTTP/1.1Host: graph.facebook.com
```
