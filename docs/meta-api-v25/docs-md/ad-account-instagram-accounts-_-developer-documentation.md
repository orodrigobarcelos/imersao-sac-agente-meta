<!-- Fonte: Ad Account Instagram Accounts _ Developer Documentation.html -->
<!-- URL: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account/instagram_accounts -->
...
```
GET /v25.0/{ad-account-id}/instagram_accounts HTTP/1.1Host: graph.facebook.com
```
