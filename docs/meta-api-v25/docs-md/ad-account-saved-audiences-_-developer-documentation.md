<!-- Fonte: Ad Account Saved Audiences _ Developer Documentation.html -->
<!-- URL: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account/saved_audiences -->
...
```
GET /v25.0/{ad-account-id}/saved_audiences HTTP/1.1Host: graph.facebook.com
```
