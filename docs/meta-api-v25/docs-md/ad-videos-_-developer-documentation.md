<!-- Fonte: Ad Videos _ Developer Documentation.html -->
<!-- URL: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account/advideos -->
...
```
GET /v25.0/{ad-account-id}/advideos HTTP/1.1Host: graph.facebook.com
```
...
| edit_description_spec JSON object | This represents the schema that the client should send to WWW for the edit description spec during video upload. screen_readers array\<JSON object\> Show child parameters |
